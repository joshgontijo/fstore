...
//        NonClusteredSparseIndex<String> index = NonClusteredSparseIndex.builder(Serializers.VSTRING, reader).build();
//
...
//
//        index = NonClusteredSparseIndex.builder(Serializers.VSTRING, reader).build();
//
//
