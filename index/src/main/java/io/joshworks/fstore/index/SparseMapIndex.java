 ...
 */
public class SparseMapIndex<K extends Comparable<K>> {

    private List<IndexEntry> midpoints = new ArrayList<>();
    ...
    public SparseMapIndex(Serializer<K> keySerializer, ByteBuffer data) {
