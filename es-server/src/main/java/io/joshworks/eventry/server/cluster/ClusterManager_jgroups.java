...
//
//public class ClusterManager_jgroups {
//
...
//
//        ClusterManager_jgroups clusterManager = new ClusterManager_jgroups(bus, 5555);
...
//
//
//    public ClusterManager_jgroups(EventBus eventBus, int port) throws Exception {
//        this.port = port;
