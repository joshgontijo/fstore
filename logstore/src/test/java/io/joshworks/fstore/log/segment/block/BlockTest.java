...
//        appender = LogAppender.builder(testFolder, Serializers.STRING).segmentSize(5242880).open();
//    }
//
//    @After
...
//    }
//
//    protected Block<String> createBlock(Serializer<String> serializer, int maxSize) {
//        return new VLenBlock<>(serializer, maxSize);
//    }
//
//    @Test
//    public void when_the_limit_is_exceeded_return_true() {
//
//        Block<String> block = createBlock(Serializers.STRING, 4);
