...
//THREAD SAFE
public class FixedBufferDataStream implements DataStream {
    ...
    public FixedBufferDataStream() {
        this(DEFAULT_CHECKUM_PROB);
    }

    public FixedBufferDataStream(double checksumProb) {
