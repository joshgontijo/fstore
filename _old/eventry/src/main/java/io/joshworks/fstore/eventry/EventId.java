...
import io.joshworks.fstore.eventry.streams.SystemStreams;

import java.util.Objects;

import static io.joshworks.fstore.eventry.utils.StringUtils.isBlank;
import static io.joshworks.fstore.eventry.utils.StringUtils.requireNonBlank;
...
public class EventId {
    ...
    private static int getVersion(String[] split, String original) {
        ...
        try {
            return Integer.parseInt(requireNonBlank(split[1], "Stream version"));
