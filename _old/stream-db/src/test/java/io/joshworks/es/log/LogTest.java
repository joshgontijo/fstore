...
public class LogTest {
    ...
    public void append_reopen() {
        ...
        ByteBuffer data = evOf(1, "stream-1", 1, "value-123");
    ...
    public void append_read() {
        ...
        int version = 111;
        long sequence = 222;
        ByteBuffer data = evOf(sequence, stream, version, "value-" + 0);
        long address = log.append(data);
    ...
    public void append_multiple_segments_read() {
        ...
        long address1 = log.append(evOf(1, "stream-1", 1, "segment-1"));
        log.roll();
        long address2 = log.append(evOf(2, "stream-2", 2, "segment-1"));
